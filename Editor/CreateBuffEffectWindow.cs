...
namespace TechCosmos.GBF.Editor
{
    public class CreateBuffEffectWindow : EditorWindow
    {
        ...
        private string namespaceName = "TechCosmos.GBF.Runtime.Effects";
        ...
        [MenuItem("Tech-Cosmos/GBF/Create Buff Script", priority = 1)]
        ...
        [MenuItem("Assets/Create/GBF/Buff Effect", priority = 40)]
        ...
        [MenuItem("Assets/Create/GBF/Execution Mode", priority = 41)]
